...
export function dlogOpt(options: DebugLogOptions, ...items: [any, ...any]): void {
...
export function dlogMessagesTest(options: DebugLogOptions, ...items: any[]): any[] {
...
function debugVars(vars: Record<string, unknown>, options?: BerryPrettyOptions): string {
